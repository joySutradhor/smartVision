...
import trackRecordBanner from "../../../assets/images/trackRecord.png";

const TracRecordBanner = () => {
  return (
    <div>
      <div className="sectionParent d-flex mt-md-5 align-items-center justify-content-between ">
        <div className="col-md-6 col-12  pe-md-4 pe-lg-5 ">
          <h1 className="d-none d-md-block pb-0 pb-md-4">Track Record</h1>
...
export default TracRecordBanner;
